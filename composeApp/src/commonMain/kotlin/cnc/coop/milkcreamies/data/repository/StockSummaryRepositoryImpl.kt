...
class StockSummaryRepositoryImpl(
    private val milkClient: MilkClient
) : StockSummaryRepository {
    override suspend fun getStockSummary(currentDate: LocalDate): Result<StockSummary> {
        return milkClient.getStockSummary(currentDate)
    }
}
